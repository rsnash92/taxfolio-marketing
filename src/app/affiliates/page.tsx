    ...
    <div className="min-h-screen bg-[#f8f9fc]">
      ...
      <main className="container mx-auto px-6 lg:px-12 py-16 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm">
            <div className="w-12 h-12 bg-[#00e3ec]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
              <Repeat className="w-6 h-6 text-[#00a8b0]" />
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-1">Recurring</div>
            <div className="text-gray-600 text-sm">Lifetime Commissions</div>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm">
            <div className="w-12 h-12 bg-[#00e3ec]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
              <BarChart3 className="w-6 h-6 text-[#00a8b0]" />
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-1">90 Days</div>
            <div className="text-gray-600 text-sm">Cookie Duration</div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 mb-16 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Recurring Revenue</h3>
                <p className="text-gray-600 text-sm">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">High Conversion Product</h3>
                <p className="text-gray-600 text-sm">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Low Payout Threshold</h3>
                <p className="text-gray-600 text-sm">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="text-gray-600 text-sm mb-2">10 Referrals</div>
              <div className="text-2xl font-bold text-[#00a8b0]">£325/year</div>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="text-gray-600 text-sm mb-2">50 Referrals</div>
              <div className="text-2xl font-bold text-[#00a8b0]">£1,625/year</div>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="text-gray-600 text-sm mb-2">100 Referrals</div>
              <div className="text-2xl font-bold text-[#00a8b0]">£3,250/year</div>
            </div>
          </div>
