  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="30 December 2024">
      ...
      <section>
        ...
        <h3>3.2 Financial Data via Open Banking (Plaid)</h3>
        <p>
        ...
        <h3>3.3 Payment Information (Stripe)</h3>
        <p>
      ...
      <section>
        ...
        <h3>4.1 To Provide Our Services (Legal Basis: Contract)</h3>
        <ul>
        ...
        <h3>4.2 To Improve Our Services (Legal Basis: Legitimate Interest)</h3>
        <ul>
        ...
        <h3>4.3 To Communicate With You (Legal Basis: Contract/Consent)</h3>
        <ul>
