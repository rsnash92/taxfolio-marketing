...
faqs:
  ...
  - question: "Do I need MTD software?"
    answer: "Yes. HMRC requires you to use recognised software that can maintain digital records and submit quarterly updates via the MTD API. TaxFolio is HMRC-recognised and fully MTD-compatible."
...
1. **Maintain digital records** using HMRC-recognised software
...
HMRC maintains an [official list of recognised MTD software](https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax) on GOV.UK.
