...
faqs:
  ...
  - question: "What do I need for Making Tax Digital?"
    answer: "You need MTD-compatible software that can store digital records, calculate tax, and submit quarterly updates to HMRC via the MTD API. You also need to connect your bank accounts for transaction imports."
---
...
TaxFolio is MTD-compatible MTD software built for UK self-employed and landlords.
...
|-------------|---------------|
| MTD-compatible | Listed on Listed on HMRC's software supplier list |
...
TaxFolio is MTD-compatible software built specifically for Making Tax Digital:
